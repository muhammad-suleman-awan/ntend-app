...
const AppWrapper = () => {
  return (
    <div className="h-screen grid grid-cols-12   bg:sm-red-100">
      <div className="lg:col-span-2 md:col-span-3 h-screen bg-[#737373]     ">
        <DrawerBoard></DrawerBoard>
      </div>
      <div className="lg:col-span-10  md:col-span-9 h-screen bg-[#dedede]  ">
